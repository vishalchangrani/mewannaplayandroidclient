...
public class TennisCourtProvider extends ContentProvider {
		...
		case TENNISCOURTS:
			...
			try {
				...
				for (ContentValues contentValues : values) {
					...
					insert.bindString(6,
							contentValues.getAsString("tennis_facility_type"));
					insert.bindString(7,
							contentValues.getAsString("tennis_name"));
					insert.bindLong(8,
    ...
    static {
        ...
        tennisCourtProjectMap.put("tennis_latitude","tennis_latitude");
        tennisCourtProjectMap.put("tennis_longitude","tennis_longitude");
        tennisCourtProjectMap.put("tennis_subcourts","tennis_subcourts");
        tennisCourtProjectMap.put("occupied","occupied");
        tennisCourtProjectMap.put("tennis_facility_type","tennis_facility_type");
        tennisCourtProjectMap.put("tennis_name","tennis_name");
