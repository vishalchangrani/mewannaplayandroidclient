...
public class BackgroundWebSerive extends IntentService implements Runnable {
    ...
    public static final String WEB_INTENT_FILTER = "mewannaplay.BackgroundWebSerive.intent.filter";
    ...
    protected void doWakefulWork(Intent intent) {
        ...
        meWannaPlayCourtsUrl = extras
                .getString(BackgroundWebSerive.EXTRAS_URL);
    ...
    public class WebBinder extends Binder {
        ...
        public BackgroundWebSerive getService() {
            Log.e("MeWannaPlay", "WebBinder getService ");
            return BackgroundWebSerive.this;
        }
    }
